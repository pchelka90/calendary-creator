  ...
  return (
    <div>
      {isDesktop() ? (
        ...
        >
          {' '}
          Wykryto urządzenie mobilne. <br /> Kreator jest dostępny jedynie na
          urządzeniach z większą rozdzielczością ekranu. <br /> Prosimy o
          skorzystanie z komputera lub laptopa.
        </p>
      )}
